...
function TareasViewer () {
    ...
    return(
        <div id="TareasViewer" className=" bg-white p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 my-5" style={{display : "block"}}>
                {/* CONTADORES */}
                <Contadores />
